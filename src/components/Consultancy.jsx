  ...
  return (
    <>
        ...
        <div className="container">
          <div className="grid" style={{gridTemplateColumns:"1.05fr 1fr", gap:28}}>
            ...
            <div className="stat-grid">
              <div className="stat">
                <h3>20+</h3><p>Years delivering results</p>
              </div>
              <div className="stat">
                <h3>100+</h3><p>Experts worldwide</p>
              </div>
              <div className="stat">
                <h3>ISO-style</h3><p>Delivery playbooks</p>
              </div>
              <div className="stat">
                <h3>WBENC & NMSDC</h3><p>Certified</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <Section refProp={ctaRef}>
        <div className="container">
          <div className="card" style={{padding:24, display:"grid", gap:12, alignItems:"center",
            gridTemplateColumns:"1fr auto"}}>
            <div>
              <h2 style={{margin:0}}>Ready to explore a consultancy engagement?</h2>
